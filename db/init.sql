...
insert into terrain values(0, 1, 'ocean', 'Ocean', true, '#0000FF', 0);
insert into terrain values(0, 1, 'sea', 'Sea', true, '#7777FF', 0);
insert into terrain values(0, 1, 'grass', 'Grassland', false, '#77FF77', 0);
insert into terrain values(0, 1, 'hills', 'Hills', false, '#55EE55', 0);
insert into terrain values(0, 1, 'broadleaf_woods', 'Woodland', false, '#44AA44', 0);
insert into terrain values(0, 1, 'broadleaf_forest', 'Broadleaf Forest', false, '#338833', 0);
insert into terrain values(0, 1, 'cropland', 'Cropland', false, '#88FF88', 0);
insert into terrain values(0, 1, 'heath', 'Heath', false, '#77EE77', 0);
insert into terrain values(0, 1, 'moors', 'Moors', false, '#55EE55', 0);
insert into terrain values(0, 1, 'dense_forest', 'Dense Forest', false, '#227722', 0);
insert into terrain values(0, 1, 'foothills', 'Foothills', false, '#44AA44', 0);
insert into terrain values(0, 1, 'mountains', 'Mountains', false, '#444444', 0);
insert into terrain values(0, 1, 'montane_forest', 'Montane Forest', false, '#447744', 0);
insert into terrain values(0, 1, 'mountains_high', 'High Mountains', false, '#444444', 0);
insert into terrain values(0, 1, 'marsh', 'Mashes', false, '#77FF77', 0);
insert into terrain values(0, 1, 'swamp', 'Swamp', false, '#77FF77', 0);
